...
export function planTopic(topic) {
  const t = (topic || '').trim();
 ...
 * 本地NLP综述生成（核心函数）
 */
export function generateLocalReview(topic, papers, plan, options = {}) {
 ...
 */
export async function generateAIReview(topic, papers, plan, model, apiKey, options = {}) {
 ...
 */
export async function generateFreeAIReview(topic, papers, plan, options = {}) {
 ...
 */
export async function generateReview(config) {
  const {
...
// 导出工具函数
// ─────────────────────────────────────────────────────────────────────────────
export { analyzeCorpus, extractKeywordsTFIDF, extractKeySentences };
