...
\author{知网学术综述生成器 (CNKI Review Assistant)\thanks{系统版本：v1.2.0 LTS (Zotero Live Enabled)}}
\date{2026年8月}
...
阿尔茨海默病（Alzheimer's disease, AD）是一种隐匿起病、呈进行性发展的致死性中枢神经退行性疾病，临床表现为进行性认知功能下降、记忆力减退、人格障碍及行为异常。随着全球人口老龄化进程加剧，AD 已成为威胁全球公共卫生健康的重大挑战。传统的 AD 病理假说主要聚焦于 $\beta$-淀粉样蛋白（Amyloid-$\beta$, A$\beta$）沉积构成的老年斑（Senile plaques）以及微管相关蛋白 Tau 异常过度磷酸化形成的神经原纤维缠结（Neurofibrillary tangles, NFTs）\cite{dominy2019, ren2024}。然而，针对单纯靶向清除脑内 A$\beta$ 的单克隆抗体药物在临床试验中往往面临获益有限或不良反应（如 ARIA）等瓶颈，促使学术界重新审视感染、全身低度免疫炎症与中枢神经退行性病变之间的深度交织关联\cite{kamer2008, nieran2019}。

牙周炎（Periodontitis）是由牙菌斑生物膜引起的牙齿支持组织（牙龈、牙周膜、牙槽骨及牙骨质）的慢性感染性破坏疾病，也是导致成年人牙齿丧失的首要原因\cite{caocaifang2004}。在长期未控制的慢性牙周炎状态下，牙周袋内壁上皮发生溃疡破损，形成了巨大的外周感染创面（成年重度牙周炎患者的溃疡面积总和可达 50--72 $\text{cm}^2$），使牙周致病微生物及其毒性代谢产物能够频繁、低剂量地进入血液循环，诱发全身系统性免疫炎症反应\cite{zhangjing2017, liyihan2018}。
...
\textit{P. gingivalis} 是一种专性厌氧、无芽孢、革兰氏阴性多形性球杆菌，属于拟杆菌门（Bacteroidetes），是牙周炎“红色复合体”（Red Complex）的关键成员，被称为口腔微生态系统的“核心致病菌”（Keystone pathogen）\cite{caocaifang2004}。其独特的病原特性并不单纯依赖于极高数量的直接组织破坏，而是通过分泌多样化的强效毒力因子逃避宿主免疫清除、重塑局域微生态环境并侵袭远隔组织器官\cite{ren2024}。其核心毒力因子体系包括四大支柱（见表\ref{tab:virulence}）：
...
\subsection{脂多糖（LPS）}
\textit{P. gingivalis} LPS 具有独特的异质性结构，其脂质 A 区域含有四酰化和五酰化两种异构体。五酰化脂质 A 可作为经典 Toll 样受体 4（TLR4）激动剂，而四酰化异构体则可表现为 TLR4 拮抗剂，甚至能够结合 TLR2。这种结构动态调节机制使 \textit{P. gingivalis} 能够在逃避宿主急性免疫监视的同时，诱导外周与中枢系统发生持久、低强度的慢性无菌性炎症级联反应\cite{zhangjing2017, ren2024}。
...
\textit{P. gingivalis} 具有侵袭非吞噬细胞及在巨噬细胞内存活的独特胞内寄生特性。外周单核/巨噬细胞吞噬 \textit{P. gingivalis} 后，该菌能够通过修饰自噬体及阻止吞噬溶酶体成熟酸化而在免疫细胞内部长期存活。随着中枢神经系统释放 MCP-1/CCL2 等炎性趋化信号，携带活菌的外周单核细胞跨过受损的脑血管壁进入脑实质（“特洛伊木马”效应），并在脑实质中释放活菌与毒力蛋白，播散神经感染\cite{nieran2019, ren2024}。

\subsection{三叉神经等脑神经轴突逆向传导}
口腔颌面部具有密集的脑神经支配网络，牙龈与牙周膜富含三叉神经（Trigeminal nerve, CN V）感觉纤维末梢。体外及动物实验发现，\textit{P. gingivalis} 及其毒力蛋白能够被周围神经轴突末梢摄取，借助神经轴浆逆行运输机制，越过 BBB 直接沿三叉神经感觉神经根上行进入三叉神经感觉核与脑干，进而向内侧颞叶、海马及大脑皮层等记忆中枢扩散\cite{nieran2019, olsen2015}。
...
微管相关蛋白 Tau 的过度磷酸化与神经原纤维缠结（NFTs）是导致神经元轴突运输瘫痪与细胞凋亡的直接推手。Dominy 等\cite{dominy2019}及俞宁等\cite{yuning2018}发现，牙龈蛋白酶对 Tau 蛋白具有直接且特异的酶切活性：
\begin{enumerate}
    ...
    \item \textbf{间接激酶激活：}\textit{P. gingivalis} 感染激活了糖原合成酶激酶-3$\beta$（GSK-3$\beta$）、p38 MAPK 及细胞周期蛋白依赖性激酶 5（CDK5）等多条 Tau 磷酸化激酶通路，同时抑制蛋白磷酸酶 2A（PP2A）的去磷酸化活性，导致 Tau 蛋白在 Thr181、Thr231、Ser202、Ser396/404 等关键表位发生弥漫性过度磷酸化\cite{ren2024, yuning2018}。
\end{enumerate}

\subsection{小胶质细胞过度激活与 NLRP3 炎症小体神经毒性风暴}
中枢神经系统的小胶质细胞（Microglia）和星形胶质细胞（Astrocytes）是脑内主要的免疫效应细胞。
\textit{P. gingivalis} LPS 与菌毛通过激活小胶质细胞表面的 TLR4/CD14 受体复合物，启动经典的 MyD88 依赖性 NF-$\kappa$B 信号转导通路，导致促炎细胞因子（TNF-$\alpha$、IL-6、IL-1$\beta$）大量转录\cite{poole2013, zhangjing2017}。
...
\begin{enumerate}
    \item \textbf{外周--中枢免疫通讯：}外周升高的 TNF-$\alpha$ 与 IL-6 可经由脉络丛内皮细胞上的特异性受体转运进入脑室系统，或通过刺激迷走神经迷走神经节感觉传入纤维向孤束核传递炎症神经信号，预先“致敏”（Priming）中枢静息态小胶质细胞\cite{kamer2008, zhangjing2017}。
    \item \textbf{双向促进恶性循环：}致敏后的小胶质细胞对脑内轻微的 A$\beta$ 沉积产生超敏免疫应答，释放更多神经毒性活性氧与前列腺素，阻碍生理性 A$\beta$ 吞噬清除机制；而受损神经元释放的损伤相关分子模式（DAMPs，如 HMGB1）进一步加重全身免疫紊乱，形成外周感染与中枢神经退变相互促进的恶性正反馈循环\cite{nieran2019, zhang2020}。
\end{enumerate}
...
\midrule
\textbf{牙周系统基础治疗} & 龈上洁治、龈下刮治与根面平整（SRP），联合局部缓释抗菌药物 & 显著降低牙周袋菌负荷与全身炎症指标（CRP、TNF-$\alpha$）；可延缓轻度认知障碍（MCI）患者认知恶化速度\cite{tangzhiqun2018} \\
\midrule
...
牙周系统治疗（Periodontal therapy）作为一种安全、低成本且成熟的临床手段，能够有效去除牙菌斑生物膜、消除局部牙周组织感染创面。临床干预研究表明，规律进行龈下刮治与根面平整（SRP）不仅能够有效控制口腔炎症，更可使患者血清 CRP 及促炎因子水平下降 30\%--50\%，并改善脑血管内皮依赖性舒张功能，对延缓老年人群认知衰退具有积极的预防保护价值\cite{tangzhiqun2018, caocaifang2004}。
...
\begin{itemize}
    \item \textbf{动物模型效果：}在感染 \textit{P. gingivalis} 的小鼠模型中，口服 COR388 能够将脑内细菌负荷降低 90\% 以上，显著阻断 A$\beta_{1-42}$ 生成，下调神经炎症因子表达，并有效保护海马区突触结构与神经元存活，逆转认知行为障碍\cite{dominy2019, yuning2018}。
...
\bibitem{nieran2019} 聂然, 周延民. 慢性牙周炎与阿尔茨海默病相关性的研究进展[J]. 口腔医学研究, 2019, 35(5): 419-422. DOI: 10.13701/j.cnki.kqyxyj.2019.05.002.
\bibitem{zhangjing2017} 张静, 周薇, 宋忠臣. 慢性牙周炎与阿尔茨海默病相关性研究进展[J]. 口腔医学, 2017, 37(4): 364-368. DOI: 10.13591/j.cnki.kqyx.2017.04.017.
\bibitem{ren2024} 任欢, 乔新, 王峥, 等. 牙龈卟啉单胞菌与阿尔茨海默病相关性致病机制[J]. 微生物学通报, 2024, 51(11): 4359-4369. DOI: 10.13344/j.microbiol.china.240148.
\bibitem{poole2013} POOLE S K, SINGHRAO S K, KESAVALU L, et al. Determining the presence of periodontopathic virulence factors in short-term postmortem Alzheimer's disease brain tissue[J]. Journal of Alzheimer's Disease, 2013, 36(4): 665-677. DOI: 10.3233/JAD-121918.
...
\bibitem{olsen2015} OLSEN I, SINGHRAO S K. Can Porphyromonas gingivalis invade the brain in Alzheimer's disease?[J]. Journal of Oral Microbiology, 2015, 7: 29930. DOI: 10.3402/jom.v7.29930.
...
\bibitem{liyihan2018} 李一涵, 潘兰兰. 牙周病与阿尔兹海默症的关系[J]. 国际口腔医学杂志, 2018, 45(3): 335-339. DOI: 10.7518/gjkq.2018.03.017.
\bibitem{qiuche2020} 邱澈, 周薇, 史文涛, 等. 牙周炎与阿尔茨海默病相关性的Meta分析[J]. 上海口腔医学, 2020, 29(6): 661-668. DOI: 10.19439/j.sjos.2020.06.020.
\bibitem{yuning2018} 俞宁, 孙尚敏, 刘博, 等. 牙龈卟啉单胞菌与阿尔茨海默病的相关性研究进展[J]. 口腔医学, 2018, 38(12): 1141-1144. DOI: 10.13591/j.cnki.kqyx.2018.12.019.
\bibitem{zhang2020} 张明爽, 巴特, 王文标. 口腔微生物种群与阿尔茨海默病相关发病机制的研究进展[J]. 国际口腔医学杂志, 2020, 47(1): 102-108. DOI: 10.7518/gjkq.2020.01.016.
\bibitem{tangzhiqun2018} 唐智群, 梁丹, 成杪莹, 等. 牙周炎与阿尔兹海默症相关性研究进展[J]. 中国实用口腔科杂志, 2018, 11(1): 52-56. DOI: 10.19538/j.kq.2018.01.011.
\bibitem{caocaifang2004} 曹采方. 牙周病与全身健康的关系[J]. 实用口腔医学杂志, 2004, 20(3): 374-376.
\end{thebibliography}
