...
\title{\textbf{牙周炎与阿尔茨海默病关联机制及牙龈卟啉单胞菌致病作用研究进展}\\[0.5em]
...
\vspace{0.5em}
\noindent\textbf{关键词：}牙周炎；阿尔茨海默病；牙龈卟啉单胞菌；牙龈蛋白酶；β-淀粉样蛋白；Tau 蛋白；神经炎症；口腔-脑轴
...
\vspace{0.5em}
\noindent\textbf{Keywords: }Periodontitis; Alzheimer's Disease; Porphyromonas gingivalis; Gingipains; Amyloid-beta; Tau Protein; Neuroinflammation; Oral-Brain Axis
